window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(e, t) {
    ...
    class a extends t.Script {
        ...
        onClick() {
            ...
            Laya.SoundManager.playSound(e.appConfig.soundClick), 
            zs.laya.tdapp.tdAppSdk.event(new zs.laya.tdapp.gameStartEvt(e.playerInfo.user_id)), 
    ...
    class n extends t.Script {
        ...
        freshBtnState() {
            ...
            // zs.laya.game.AppMain.ReliveChance <= 0 ? this.statusClip.index = 3 : 
            // e && zs.laya.platform.ADConfig.enableClickRevive() ? this.statusClip.index = 2 : e && zs.laya.platform.ADConfig.enableVideoRevive() && zs.laya.sdk.SdkService.isVideoEnable() ? this.statusClip.index = 0 : e && zs.laya.platform.ADConfig.enableShareRevive() ? this.statusClip.index = 1 : this.statusClip.index = 3;
        }
        relive() {
    ...
    class l extends t.Script {
        ...
        onClick() {
            window.ggmgr.xsi();
            console.log("next")
            Laya.SoundManager.playSound(zs.laya.game.AppMain.appConfig.soundClick), this.owner.mouseEnabled = !1, 
            t.stage.event(zs.laya.game.EventId.GAME_OVER);
        }
    }
