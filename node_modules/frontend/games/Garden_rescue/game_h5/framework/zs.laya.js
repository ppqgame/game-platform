window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(t, e) {
    ...
    class u extends e.Script3D {
        ...
        static init(t, e, s) {
            ...
            null == i && (i = t.addComponent(u)), i.sign = e, i.loadedCb = s, i.sleep = !1, 
    ...
    class S extends e.AnimatorStateScript {
        ...
        static init(t, e, s) {
            ...
            if (null != i) {
                var r = i.getScript(S);
                null == r && (r = i.addScript(S)), r.stateName = e, r.animator = t, r.listener = s, 
    ...
    t.DataCache = r, t.XHRUtils = i, t.MiscUtils = s, t.Resource = a, t.SoundService = n, 
