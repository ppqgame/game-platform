window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(e, s) {
    ...
    t.PLATFORM_ADD_COIN = "PLATFORM_ADD_COIN", s.ILaya.regClass(t), s.ClassUtils.regClass("zs.laya.game.EventId", t), 
    s.ClassUtils.regClass("Zhise.EventId", t);
    class a {
        constructor() {}
    }
    ...
    class i {
        ...
        static requestLoginByCode(e, s) {
            var t = s || {};
            t.code = e, t.timestamp = Date.now(), this.UseWebApi && (
                this.RequestSign ? zs.laya.XHRUtils.xhrPostWithSign(this.WebApiMap.login, t, this.RequestSign) : zs.laya.XHRUtils.xhrPost(this.WebApiMap.login, t), 
            console.log("this.UseWebApi",this.UseWebApi,this.WebApiMap.login));
        }
    ...
    class n extends s.Script {
        ...
        onAwake() {
            ...
            s.stage.on(t.UI_VIEW_OPENED, this, this.onViewOpened), s.loader.load([ "config/gameCfg.json", "config/publishVer.json" ], s.Handler.create(this, this.onGameCfgReady)), 
            o.viewScript = {
        ...
        onDestroy() {
            ...
            s.stage.off(t.UI_VIEW_OPENED, this, this.onViewOpened);
        }
        onViewClosed(e, s) {}
        onViewOpened(e, s) {
        ...
        onGameCfgReady() {
            ...
            o.viewConfig = e.viewMap, o.openSound = e.soundViewOpen, s.stage.once(t.UI_VIEW_OPENED, this, this.onLoadingOpened, [ e.baseResList, e.fontList, e.configList ]), 
            o.showLoading(), n.appConfig.useWebAdApi && s.loader.load([ "config/platformCfg.json" ], s.Handler.create(this, this.onPlatformCfgReady)), 
            this.login();
        }
        onPlatformCfgReady() {
        ...
        onLaunchResReady(e) {
            this.currentLoadStep++, this.launchResReady = !0, 
            this.default3DScene = e, 
        ...
        onNetXHRResponse(e, o, r, l) {
            ...
            switch ( o) {
              case i.WebApiMap.login:
                ...
                zs.laya.platform.PlatformMgr.setUserID(p.user_id, p.is_new), 
                zs.laya.tdapp.tdAppSdk.event(new zs.laya.tdapp.loginEvt(p.user_id)), 
              ...
              case i.WebApiMap.gameCfg:
                    var data = {"zs_opening_push_num":0,"nMaxVit":10}
                    n.gameSetting = n.webResponseAdapter.BaseCfgResponse(data), s.stage.event(t.DATA_SETTING_UPDATE), 
        ...
        launchCompleted() {
            if (this.launchResReady && this.isCFGReady) {
                ...
                s.stage.event(t.LAUNCH_COMPLETED, this.default3DScene), zs.laya.platform.PlatformMgr.enterGamePopup();
        ...
        onGamePrepare(e) {
            ...
            ADManageLaya.getInstance().xsi(true);

            this.nextResWait = !1, this.nextResReady = !1, n.GameState = a.STATE_PREPARE, 
            n.appConfig.bgm && zs.laya.SoundService.playMusic(n.appConfig.bgm), 
        ...
        onOpenFailedView(e) {
            n.GameState == a.STATE_PLAYING && (n.isWin = !1, n.autoStartNext = !1, zs.laya.SoundService.stopMusic(), 
            n.GameState = a.STATE_PAUSE, o.showRelive(e), n.reliveChance -= 1);
        }
        onOpenWinView(e) {
            n.GameState == a.STATE_PLAYING && (n.autoStartNext = !1, zs.laya.SoundService.stopMusic(), 
            n.GameState = a.STATE_PAUSE, o.showScore(e));
        }
        isOpenExportGame() {
        ...
        onGameWin(e) {
            n.isWin = !0, this.reportTalkData(), this.isOpenExportGame() ? zs.laya.platform.PlatformMgr.onGameWinPopUp(e) : this.onOpenWinView(e), 
        ...
        login() {
            ...
            zs.laya.sdk.SdkService.login(s.Handler.create(this, function(e) {
                ...
                // console.error("login platform error:" + e), 1 == e.code && (console.log("2---------------登录：" + n.appConfig.defaultCfg.playerInfo.user_id), 
